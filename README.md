...
- [webflow/mcp-server](https://github.com/webflow/mcp-server) ([0.7.0](https://github.com/webflow/mcp-server/releases/tag/0.7.0), today) - Model Context Protocol (MCP) server for the Webflow Data API.
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([@tonightpass/nest@0.0.126](https://github.com/tonightpass/tonightpass/releases/tag/%40tonightpass/nest%400.0.126), 3 days ago) - @tonightpass sdk and tools.
...
- [Add new CMS tools for retrieving specific collection items](https://github.com/webflow/mcp-server/pull/54) on [webflow/mcp-server](https://github.com/webflow/mcp-server) (6 days ago)
