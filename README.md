...
- [ashbuilds/payload-ai](https://github.com/ashbuilds/payload-ai) - AI Plugin is a powerful extension for the Payload CMS, integrating advanced AI capabilities to enhance content creation and management. (5 days ago)
...
- [needforschool/excelsior](https://github.com/needforschool/excelsior) - QuickServe project (3 weeks ago)
- [tonightpass/kitchn](https://github.com/tonightpass/kitchn) - @tonightpass delicious React @styled-components (4 weeks ago)
- [webflow/mcp-server](https://github.com/webflow/mcp-server) - Model Context Protocol (MCP) server for the Webflow Data API. (1 month ago)
- [needforschool/slides-event-architecture](https://github.com/needforschool/slides-event-architecture) -  (1 month ago)

#### 🔭 Latest releases I've contributed to

- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([tonightpass@0.0.130](https://github.com/tonightpass/tonightpass/releases/tag/tonightpass%400.0.130), 4 days ago) - @tonightpass sdk and tools.
- [webflow/mcp-server](https://github.com/webflow/mcp-server) ([0.6.0](https://github.com/webflow/mcp-server/releases/tag/0.6.0), 2 weeks ago) - Model Context Protocol (MCP) server for the Webflow Data API.
...
- [antoinekm/staging](https://github.com/antoinekm/staging) ([staging@0.0.7](https://github.com/antoinekm/staging/releases/tag/staging%400.0.7), 6 months ago) - Password protect your staging &amp; preview deployments. Free open-source alternative to Vercel &amp; Netlify password protection - Next.js, Nuxt, Express
...
- [refactor(components): use explicit interfaces for component props](https://github.com/shadcn-ui/ui/pull/7605) on [shadcn-ui/ui](https://github.com/shadcn-ui/ui) (4 days ago)
- [[fix] add authentication and access control to ai endpoints](https://github.com/ashbuilds/payload-ai/pull/94) on [ashbuilds/payload-ai](https://github.com/ashbuilds/payload-ai) (5 days ago)
- [✨ add profile and orders](https://github.com/needforschool/excelsior/pull/6) on [needforschool/excelsior](https://github.com/needforschool/excelsior) (4 weeks ago)
- [✨ add auth integration](https://github.com/needforschool/excelsior/pull/5) on [needforschool/excelsior](https://github.com/needforschool/excelsior) (4 weeks ago)
- [🚧 add work on integration](https://github.com/needforschool/excelsior/pull/4) on [needforschool/excelsior](https://github.com/needforschool/excelsior) (4 weeks ago)
...
- [Kremilly/GHPinnedAPI](https://github.com/Kremilly/GHPinnedAPI) - Get your pinned repositories api (4 days ago)
- [pvorb/npm-stat.com](https://github.com/pvorb/npm-stat.com) - download statistics for npm packages (4 days ago)
- [shuding/liquid-glass](https://github.com/shuding/liquid-glass) -  (5 days ago)
- [janbuchar/payload-oapi](https://github.com/janbuchar/payload-oapi) - A Payload CMS plugin for OpenAPI (3.0, 3.1) specification generation (5 days ago)
...
- [makeplane/plane](https://github.com/makeplane/plane) - 🔥 🔥 🔥 Open Source JIRA, Linear, Monday, and Asana Alternative. Plane helps you track your issues, epics, and cycles the easiest way on the planet. (2 weeks ago)
- [facebook/pyrefly](https://github.com/facebook/pyrefly) - A fast type checker and IDE for Python (2 weeks ago)
