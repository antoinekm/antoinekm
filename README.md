...
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([@tonightpass/react@0.0.264](https://github.com/tonightpass/tonightpass/releases/tag/%40tonightpass/react%400.0.264), 1 day ago) - @tonightpass sdk and tools.
...
- [Moestash/soundcloud.ts](https://github.com/Moestash/soundcloud.ts) - Wrapper for the Soundcloud API with typings (today)
- [millionco/react-doctor](https://github.com/millionco/react-doctor) - Your agent writes bad React. This catches it (2 days ago)
- [vibheksoni/stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp) - The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat. (3 days ago)
- [vercel-labs/open-agents](https://github.com/vercel-labs/open-agents) - An open source template for building cloud agents. (6 days ago)
- [googleads/google-ads-mcp](https://github.com/googleads/google-ads-mcp) -  (6 days ago)
