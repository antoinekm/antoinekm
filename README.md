...
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([@tonightpass/react@0.0.265](https://github.com/tonightpass/tonightpass/releases/tag/%40tonightpass/react%400.0.265), 1 day ago) - @tonightpass sdk and tools.
...
- [Moestash/soundcloud.ts](https://github.com/Moestash/soundcloud.ts) - Wrapper for the Soundcloud API with typings (3 days ago)
- [millionco/react-doctor](https://github.com/millionco/react-doctor) - Your agent writes bad React. This catches it (5 days ago)
- [vibheksoni/stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp) - The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat. (6 days ago)
...
- [komoot/photon](https://github.com/komoot/photon) - an open source geocoder for openstreetmap data (1 week ago)
