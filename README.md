...
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([@tonightpass/react@0.0.214](https://github.com/tonightpass/tonightpass/releases/tag/%40tonightpass/react%400.0.214), 2 days ago) - @tonightpass sdk and tools.
...
- [webflow/mcp-server](https://github.com/webflow/mcp-server) ([1.0.0](https://github.com/webflow/mcp-server/releases/tag/1.0.0), 3 weeks ago) - Model Context Protocol (MCP) server for the Webflow Data API.
...
- [peterldowns/localias](https://github.com/peterldowns/localias) - custom local domain aliases for local dev servers (4 days ago)
...
- [Sacobrt/cyclic-table](https://github.com/Sacobrt/cyclic-table) - A small interactive Next.js app that generates and visualizes &#34;cyclic&#34; numbered tables (spiral or center-out layouts). (2 weeks ago)
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) - Tesseract Open Source OCR Engine (main repository) (4 weeks ago)
