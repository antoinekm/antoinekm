...
- [webflow/mcp-server](https://github.com/webflow/mcp-server) ([0.6.0](https://github.com/webflow/mcp-server/releases/tag/0.6.0), 3 days ago) - Model Context Protocol (MCP) server for the Webflow Data API.
...
- [makeplane/plane](https://github.com/makeplane/plane) - 🔥 🔥 🔥 Open Source JIRA, Linear, Monday, and Asana Alternative. Plane helps you track your issues, epics, and cycles the easiest way on the planet. (3 days ago)
- [facebook/pyrefly](https://github.com/facebook/pyrefly) - A fast type checker and IDE for Python (5 days ago)
...
- [mazyar-kawa/npm-downlytics](https://github.com/mazyar-kawa/npm-downlytics) -  (1 week ago)
