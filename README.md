...
- [ashbuilds/payload-ai](https://github.com/ashbuilds/payload-ai) - AI Plugin is a powerful extension for the Payload CMS, integrating advanced AI capabilities to enhance content creation and management. (6 days ago)
...
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([tonightpass@0.0.130](https://github.com/tonightpass/tonightpass/releases/tag/tonightpass%400.0.130), 5 days ago) - @tonightpass sdk and tools.
...
- [refactor(components): use explicit interfaces for component props](https://github.com/shadcn-ui/ui/pull/7605) on [shadcn-ui/ui](https://github.com/shadcn-ui/ui) (5 days ago)
- [[fix] add authentication and access control to ai endpoints](https://github.com/ashbuilds/payload-ai/pull/94) on [ashbuilds/payload-ai](https://github.com/ashbuilds/payload-ai) (6 days ago)
...
- [JacobLinCool/node-cloudflared](https://github.com/JacobLinCool/node-cloudflared) - Cloudflared in Node. Create HTTPS tunnel in 10 seconds. Works on macOS, Linux, and Windows. (today)
...
- [Kremilly/GHPinnedAPI](https://github.com/Kremilly/GHPinnedAPI) - Get your pinned repositories api (5 days ago)
- [pvorb/npm-stat.com](https://github.com/pvorb/npm-stat.com) - download statistics for npm packages (5 days ago)
- [shuding/liquid-glass](https://github.com/shuding/liquid-glass) -  (6 days ago)
- [janbuchar/payload-oapi](https://github.com/janbuchar/payload-oapi) - A Payload CMS plugin for OpenAPI (3.0, 3.1) specification generation (6 days ago)
